...
const Inventario = () => {
  ...
  const filteredData = data
    ...
    .filter((item) => {
      ...
      if (stockFilter === "disponible" && item.inventario > 10) return true;
      if (stockFilter === "proximo" && item.inventario <= 10 && item.inventario > 0) return true;
      if (stockFilter === "agotado" && item.inventario === 0) return true;
      return false;
    })
    .sort((a, b) => {

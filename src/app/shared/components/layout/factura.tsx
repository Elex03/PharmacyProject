  ...
  useEffect(() => {
    getBillData(selectedSaleId)
      .then((data) => {
        ...
        const detallesConvertidos = data.productos.map(
          (item: ProductoItem) => ({
            nombre: item.nombre,
            precio: item.precio,
      ...
      <div className="receipt-popup">
        <div className="receipt-content">
          ...
          <div className="receipt-header">
            <p>
              <strong>No. Factura:</strong> {saleData?.id ?? "N/A"}
            </p>
            <p>
          ...
          <div className="Info-Client">
            <p>
              <strong>Cliente:</strong> {saleData?.nombre ?? "N/A"}
            </p>
            <p>
              <strong>Fecha de compra:</strong> {saleData?.fechacompra ?? "N/A"}
            </p>
          </div>
          ...
          <div className="summary">
            ...
            <p>
              ...
              {saleData?.montoPagado.toFixed(2)}
            </p>
            <p>
              <strong>- Total a regresar:</strong> C$
              {(saleData ? saleData.montoPagado - totalVenta : 0).toFixed(2)}
            </p>
